<template>
  <div class="pt-24 flex flex-col justify-center">
    <div class="inputs flex flex-row">
      ...
      <input type="text" id="gitlab-username"
    ...
    <button type="button" class="bg-indigo-600 text-white text-sm leading-6 font-medium py-2 px-3 rounded-lg">Merge your graph</button>
  </div>
</template>
